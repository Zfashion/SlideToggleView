...
public class LightWave {
    ...
    public abstract static class Builder<T extends Builder<T>> {
        final LightWave lightWave = new LightWave();
        ...
        T consumeAttributes(TypedArray a) {
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_clip_to_children)) {
                setClipToChildren(
                        a.getBoolean(
                                R.styleable.LightWaveFrameLayout_wave_clip_to_children, lightWave.clipToChildren));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_auto_start)) {
                setAutoStart(
                        a.getBoolean(R.styleable.LightWaveFrameLayout_wave_auto_start, lightWave.autoStart));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_base_alpha)) {
                setBaseAlpha(a.getFloat(R.styleable.LightWaveFrameLayout_wave_base_alpha, 0.3f));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_highlight_alpha)) {
                setHighlightAlpha(a.getFloat(R.styleable.LightWaveFrameLayout_wave_highlight_alpha, 1f));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_duration)) {
                setDuration(
                        a.getInt(
                                R.styleable.LightWaveFrameLayout_wave_duration, (int) lightWave.animationDuration));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_repeat_count)) {
                setRepeatCount(
                        a.getInt(R.styleable.LightWaveFrameLayout_wave_repeat_count, lightWave.repeatCount));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_repeat_delay)) {
                setRepeatDelay(
                        a.getInt(
                                R.styleable.LightWaveFrameLayout_wave_repeat_delay, (int) lightWave.repeatDelay));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_repeat_mode)) {
                setRepeatMode(
                        a.getInt(R.styleable.LightWaveFrameLayout_wave_repeat_mode, lightWave.repeatMode));
            }

            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_direction)) {
                int direction =
                        a.getInt(R.styleable.LightWaveFrameLayout_wave_direction, lightWave.direction);
                switch (direction) {
                    default:
            ...
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_shape)) {
                int shape = a.getInt(R.styleable.LightWaveFrameLayout_wave_shape, lightWave.shape);
                switch (shape) {
                    default:
                    case Shape.LINEAR:
            ...
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_dropoff)) {
                setDropoff(a.getFloat(R.styleable.LightWaveFrameLayout_wave_dropoff, lightWave.dropoff));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_fixed_width)) {
                setFixedWidth(
                        a.getDimensionPixelSize(
                                R.styleable.LightWaveFrameLayout_wave_fixed_width, lightWave.fixedWidth));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_fixed_height)) {
                setFixedHeight(
                        a.getDimensionPixelSize(
                                R.styleable.LightWaveFrameLayout_wave_fixed_height, lightWave.fixedHeight));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_intensity)) {
                setIntensity(
                        a.getFloat(R.styleable.LightWaveFrameLayout_wave_intensity, lightWave.intensity));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_width_ratio)) {
                setWidthRatio(
                        a.getFloat(R.styleable.LightWaveFrameLayout_wave_width_ratio, lightWave.widthRatio));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_height_ratio)) {
                setHeightRatio(
                        a.getFloat(R.styleable.LightWaveFrameLayout_wave_height_ratio, lightWave.heightRatio));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_tilt)) {
                setTilt(a.getFloat(R.styleable.LightWaveFrameLayout_wave_tilt, lightWave.tilt));
            }
            return getThis();
        }
        ...
        public T setFixedWidth(@Px int fixedWidth) {
            ...
            lightWave.fixedWidth = fixedWidth;
            return getThis();
        }
        ...
        public T setFixedHeight(@Px int fixedHeight) {
            ...
            lightWave.fixedHeight = fixedHeight;
            return getThis();
        }
        ...
        public T setWidthRatio(float widthRatio) {
            ...
            lightWave.widthRatio = widthRatio;
            return getThis();
        }
        ...
        public T setHeightRatio(float heightRatio) {
            ...
            lightWave.heightRatio = heightRatio;
            return getThis();
        }
        ...
        public T setBaseAlpha(@FloatRange(from = 0, to = 1) float alpha) {
            ...
            lightWave.baseColor = intAlpha << 24 | (lightWave.baseColor & 0x00FFFFFF);
            return getThis();
        }
        ...
        public T setHighlightAlpha(@FloatRange(from = 0, to = 1) float alpha) {
            int intAlpha = (int) (clamp(0f, 1f, alpha) * 255f);
            lightWave.highlightColor = intAlpha << 24 | (lightWave.highlightColor & 0x00FFFFFF);
            return getThis();
        }
        ...
        public T setRepeatCount(int repeatCount) {
            lightWave.repeatCount = repeatCount;
            return getThis();
        }
        ...
        public T setDuration(long millis) {
            ...
            lightWave.animationDuration = millis;
            return getThis();
        }

        public  LightWave build() {
            lightWave.updateColors();
            lightWave.updatePositions();
            return lightWave;
        }
    ...
    public static class ColorHighlightBuilder extends Builder<ColorHighlightBuilder> {
        ...
        ColorHighlightBuilder consumeAttributes(TypedArray a) {
            ...
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_base_color)) {
                setBaseColor(
                        a.getColor(R.styleable.LightWaveFrameLayout_wave_base_color, lightWave.baseColor));
            }
            if (a.hasValue(R.styleable.LightWaveFrameLayout_wave_highlight_color)) {
                setHighlightColor(
                        a.getColor(
                                R.styleable.LightWaveFrameLayout_wave_highlight_color, lightWave.highlightColor));
            }
            return getThis();
        }
